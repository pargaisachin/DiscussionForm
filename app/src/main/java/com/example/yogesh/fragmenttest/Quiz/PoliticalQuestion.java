 ...
 */
public class PoliticalQuestion extends Activity {
    private int id;
    ...
    public PoliticalQuestion(String q, String oa, String ob, String oc, String od, String ans) {
